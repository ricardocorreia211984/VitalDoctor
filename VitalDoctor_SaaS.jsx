  ...
  return (
    <div className="fade">
      ...
      {[
        ...
        { id:"pack_s2", form:"form_b", icon:"2️⃣", titulo:nomes.pack_s2, sub:"Análise Profunda", desc:"Avaliação detalhada → Análise energética → Identificação de padrões → Protocolo de tratamento", tags:["Pack","Análise","Raiz do sintoma"] },
        ...
        { id:"avaliacao_energetica", form:"form_b", icon:"🔬", titulo:"Avaliação Energética", sub:"Avaliação independente", desc:"Avaliação completa fora de pack — para análise profunda e identificação de causas raiz", tags:["Avulso","Análise profunda"] },
      ].map(t=>(
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 10 }}>
              {users.map(u => (
                <div key={u.id} style={{ background: 'linear-gradient(135deg, #0a1e2e, #061428)', border: '1px solid #d4a574', borderRadius: 6, padding: 10 }}>
                  ...
                  >
                    {u.has_exclusive_therapy_access ? '⭐ Exclusivo ACTIVO — clica para revogar' : '🔒 Exclusivo INACTIVO — clica para activar'}
                  </button>
                )}
                </div>
              ))}
