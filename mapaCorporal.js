...
export const PONTOS_ENTRADA = [
  { id: "topo",    nome: "Topo da cabeça",       bilateral: false, significado: "Conflito existencial / perda de sentido." },
  { id: "ombros",  nome: "Ombros",               bilateral: true,  significado: "Peso, responsabilidade e culpa. Direito: obrigações externas; esquerdo: emocional." },
  { id: "tronco",  nome: "Laterais do tronco",   bilateral: true,  significado: "Autoproteção e medo de exposição emocional." },
  { id: "maos",    nome: "Mãos",                 bilateral: true,  significado: "Ação, dar e receber; não conseguir impedir ou segurar." },
  { id: "ancas",   nome: "Ancas / coxas",        bilateral: true,  significado: "Vínculos e movimento; perder o chão nas relações." },
  { id: "joelhos", nome: "Joelhos",              bilateral: true,  significado: "Humildade, rendição; orgulho ferido." },
  { id: "pes",     nome: "Pés",                  bilateral: true,  significado: "Caminho, direção, raízes; medo de avançar ou ser tirado do lugar." },
];
